...
internal class BookingCancelMaintenanceControllerTest : FlowTestSupport() {
    ...
    fun cancel() {
        ...
        val cancelFlow = BookingCancelMaintenanceControllerFlow(mockMvc)
        ...
        val cancelFee = 100L
        cancelFlow.cancel(checkoutRequest.userId, bookingIds, cancelFee)
        ...
        recordDetail.asClue {
            ...
            it.receipt.totalRefundAmount shouldBe it.receipt.totalPaidAmount - cancelFee
